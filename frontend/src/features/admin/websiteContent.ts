...
export const SECTIONS: SectionMeta[] = [
  {
    ...
    fields: [
      ...
      { key: 'hero.posterUrl', label: 'Poster image URL', type: 'url', isImage: true },
      { key: 'hero.mobileImageUrl', label: 'Mobile fallback image URL', type: 'url', isImage: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'about.imageUrl', label: 'Image URL', type: 'url', full: true, isImage: true },
